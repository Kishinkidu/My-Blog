        ...
        <>
            <div className="h-screen flex justify-center items-center bg-gray-200">
                <div className="artboard-demo phone-2 p-6">
                    ...
                    <form onSubmit={handleSubmit} action="" className="mt-10 w-full" noValidate>
                        <div>
                            <input
                                type="email"
                                value={inputs.email}
                                ...
                                className={`border ${isValidEmail ? "border-red-500" : "border-gray-300 "
                        ...
                        <div className="mt-6">
                            <input
                                ...
                                className={`border ${isValidPassword ? "border-red-500" : "border-gray-300"
                                    }   rounded-lg p-3 w-full bg-gray-50`}
                            />
                            {isValidPassword && (
                                <span className="text-red-500 mt-2 text-sm">
